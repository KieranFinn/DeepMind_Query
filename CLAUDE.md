...
**YOU ARE IN: `DeepMind_Query/polecats/basalt/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/DeepMind_Query/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/basalt
```
...
**Your mail address:** `DeepMind_Query/polecats/basalt`
**Your rig:** DeepMind_Query
**Your Witness:** `DeepMind_Query/witness`
...
1. Announce: "Polecat basalt, checking in."
...
| Ask Witness for help | `gt mail send DeepMind_Query/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`DeepMind_Query/witness`) when:
...
```bash
gt mail send DeepMind_Query/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
