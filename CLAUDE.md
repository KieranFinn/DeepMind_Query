...
**YOU ARE IN: `DeepMind_Query/polecats/shale/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/shale
```
...
**Your mail address:** `DeepMind_Query/polecats/shale`
...
1. Announce: "Polecat shale, checking in."
